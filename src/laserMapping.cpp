...
{
    timeLaserCloudCornerLast = laserCloudCornerLast2->header.stamp.sec + 1e-9 * laserCloudCornerLast2->header.stamp.nanosec;
...
{
    timeLaserCloudSurfLast = laserCloudSurfLast2->header.stamp.sec + 1e-9 * laserCloudSurfLast2->header.stamp.nanosec;
...
{
    timeLaserCloudFullRes = laserCloudFullRes2->header.stamp.sec + 1e-9 * laserCloudFullRes2->header.stamp.nanosec;
...
int main(int argc, char** argv)
{
    ...
    auto subscription = node->create_subscription<sensor_msgs::msg::PointCloud2>("laser_cloud_sharp", 100, laserCloudCornerLastHandler);
    auto subLaserCloudSurfLast = node->create_subscription<sensor_msgs::msg::PointCloud2>("laser_cloud_flat", 100, laserCloudSurfLastHandler);
    auto subLaserCloudFullRes = node->create_subscription<sensor_msgs::msg::PointCloud2>("livox_cloud", 100, laserCloudFullResHandler);
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pubLaserCloudSurround = node->create_publisher<sensor_msgs::msg::PointCloud2>("laser_cloud_surround", rclcpp::QoS(100));
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pubLaserCloudSurround_corner = node->create_publisher<sensor_msgs::msg::PointCloud2>("laser_cloud_surround_corner", rclcpp::QoS(100));
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pubLaserCloudFullRes = node->create_publisher<sensor_msgs::msg::PointCloud2>("velodyne_cloud_registered", rclcpp::QoS(100));
    
    rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr pubOdomAftMapped = node->create_publisher<nav_msgs::msg::Odometry>("aft_mapped_to_init", rclcpp::QoS(1));
    ...
    node->declare_parameter<double>("filter_parameter_corner", 0.1);
    node->get_parameter("filter_parameter_corner", filter_parameter_corner);
    double filter_parameter_surf;
    node->declare_parameter<double>("filter_parameter_surf", 0.2);
    node->get_parameter("filter_parameter_surf", filter_parameter_surf);
    ...
    while (rclcpp::ok())
    {
        ...
        if (newLaserCloudCornerLast && newLaserCloudSurfLast && newLaserCloudFullRes &&
            ...
            laserCloudSurround3.header.stamp.sec = static_cast<int32_t>(timeLaserCloudCornerLast);
            laserCloudSurround3.header.stamp.nanosec = static_cast<uint32_t>((timeLaserCloudCornerLast - static_cast<int32_t>(timeLaserCloudCornerLast)) * 1e9);
            laserCloudSurround3.header.frame_id = "/camera_init";
            pubLaserCloudSurround->publish(std::move(laserCloudSurround3));

            sensor_msgs::msg::PointCloud2 laserCloudSurround3_corner;
            pcl::toROSMsg(*laserCloudSurround2_corner, laserCloudSurround3_corner);
            laserCloudSurround3_corner.header.stamp.sec = static_cast<int32_t>(timeLaserCloudCornerLast);
            laserCloudSurround3_corner.header.stamp.nanosec = static_cast<uint32_t>((timeLaserCloudCornerLast - static_cast<int32_t>(timeLaserCloudCornerLast)) * 1e9);
                        
            laserCloudSurround3_corner.header.frame_id = "/camera_init";
            pubLaserCloudSurround_corner->publish(std::move(laserCloudSurround3_corner));
            ...
            *laserCloudFullRes2 = *laserCloudFullRes;
            ...
            laserCloudFullRes3.header.stamp.sec = static_cast<int32_t>(timeLaserCloudCornerLast);
            laserCloudFullRes3.header.stamp.nanosec = static_cast<uint32_t>((timeLaserCloudCornerLast - static_cast<int32_t>(timeLaserCloudCornerLast)) * 1e9);

            laserCloudFullRes3.header.frame_id = "/camera_init";
            pubLaserCloudFullRes->publish(std::move(laserCloudFullRes3));

            *laserCloudFullResColor_pcd += *laserCloudFullResColor;

            tf2::Quaternion tf2_quat;
            tf2_quat.setRPY(transformAftMapped[2], -transformAftMapped[0], -transformAftMapped[1]);
            
            geometry_msgs::msg::Quaternion geoQuat;
            tf2::convert(tf2_quat, geoQuat);
            
            odomAftMapped.header.stamp.sec = static_cast<int32_t>(timeLaserCloudCornerLast);
            odomAftMapped.header.stamp.nanosec = static_cast<uint32_t>((timeLaserCloudCornerLast - static_cast<int32_t>(timeLaserCloudCornerLast)) * 1e9);
            ...
            pubOdomAftMapped->publish(std::move(odomAftMapped));
            ...
            RCLCPP_INFO(node->get_logger(), "Mapping time: %ld %ld %ld", t2 - t1, t3 - t2, t4 - t3);
